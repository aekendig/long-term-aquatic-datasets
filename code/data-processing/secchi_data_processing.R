...
lw_qual %>%
  filter(QualityMetric %in% c("CHL_ug_L", "Secchi_ft", "TP_ug_L", "Secchi_ft", "Color_Pt_Co_Units", "Cond_uS_cm")) %>%
...
write_csv(lw_qual2, "intermediate-data/LW_secchi_formatted.csv")
write_csv(wa_qual2, "intermediate-data/water_atlas_secchi_formatted.csv")
write_csv(qual2, "intermediate-data/LW_water_atlas_secchi_formatted.csv")
