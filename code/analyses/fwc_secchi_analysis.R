...
# focal water quality
dat <- filter(qual, QualityMetric == "Secchi_ft")
dat_full <- filter(qual_full, QualityMetric == "Secchi_ft")

# taxa
inv_taxa <- sort(unique(dat$CommonName))

# loop through taxa
pdf("output/secchi_time_series_by_taxon.pdf")
...
for(i in inv_taxa){
  ...
  print(ggplot(subdat, aes(x = GSYear, y = QualityMean, color = PermanentID)) +
          ...
          labs(x = "Year", y = "Secchi disk depth (ft)", title = i) +
          def_theme_paper +
...
# save data
write_csv(dat, "intermediate-data/FWC_secchi_analysis_formatted.csv")
...
# hydrilla treatment decreases sec until location is accounted for, then increase
# hydrilla slightly increases sec
# recent treatment interaction makes management effect negative again
# interaction is minimal

# accounting for location reduces the negative effect of floating plants & treatments
# both decrease it
# recent treatment similar to treated
# interaction removes plant effect
...
# accounting for location switches the torpedograss effect to negative, but not with location and year
# accounting for location switches treatment effect to positive
# both increase sec
# recent similar to treated
# interaction increases sec
...
# export models
save(hydr_mean_mod, file = "output/fwc_hydrilla_mean_secchi_model.rda")
save(flpl_mean_mod, file = "output/fwc_floating_plant_mean_secchi_model.rda")
save(cubu_mean_mod, file = "output/fwc_cuban_bulrush_mean_secchi_model.rda")
save(torp_mean_mod, file = "output/fwc_torpedograss_mean_secchi_model.rda")

save(hydr_max_mod, file = "output/fwc_hydrilla_max_secchi_model.rda")
save(flpl_max_mod, file = "output/fwc_floating_plant_max_secchi_model.rda")
save(cubu_max_mod, file = "output/fwc_cuban_bulrush_max_secchi_model.rda")
save(torp_max_mod, file = "output/fwc_torpedograss_max_secchi_model.rda")

save(hydr_min_mod, file = "output/fwc_hydrilla_min_secchi_model.rda")
save(flpl_min_mod, file = "output/fwc_floating_plant_min_secchi_model.rda")
save(cubu_min_mod, file = "output/fwc_cuban_bulrush_min_secchi_model.rda")
save(torp_min_mod, file = "output/fwc_torpedograss_min_secchi_model.rda")

save(hydr_cv_mod, file = "output/fwc_hydrilla_cv_secchi_model.rda")
save(flpl_cv_mod, file = "output/fwc_floating_plant_cv_secchi_model.rda")
save(cubu_cv_mod, file = "output/fwc_cuban_bulrush_cv_secchi_model.rda")
save(torp_cv_mod, file = "output/fwc_torpedograss_cv_secchi_model.rda")
...
# export models
save(hydr_mean_mod_full, file = "output/fwc_hydrilla_mean_secchi_binary_model.rda")
save(flpl_mean_mod_full, file = "output/fwc_floating_plant_mean_secchi_binary_model.rda")
save(cubu_mean_mod_full, file = "output/fwc_cuban_bulrush_mean_secchi_binary_model.rda")
save(torp_mean_mod_full, file = "output/fwc_torpedograss_mean_secchi_binary_model.rda")

save(hydr_max_mod_full, file = "output/fwc_hydrilla_max_secchi_binary_model.rda")
save(flpl_max_mod_full, file = "output/fwc_floating_plant_max_secchi_binary_model.rda")
save(cubu_max_mod_full, file = "output/fwc_cuban_bulrush_max_secchi_binary_model.rda")
save(torp_max_mod_full, file = "output/fwc_torpedograss_max_secchi_binary_model.rda")

save(hydr_min_mod_full, file = "output/fwc_hydrilla_min_secchi_binary_model.rda")
save(flpl_min_mod_full, file = "output/fwc_floating_plant_min_secchi_binary_model.rda")
save(cubu_min_mod_full, file = "output/fwc_cuban_bulrush_min_secchi_binary_model.rda")
save(torp_min_mod_full, file = "output/fwc_torpedograss_min_secchi_binary_model.rda")

save(hydr_cv_mod_full, file = "output/fwc_hydrilla_cv_secchi_binary_model.rda")
save(flpl_cv_mod_full, file = "output/fwc_floating_plant_cv_secchi_binary_model.rda")
save(cubu_cv_mod_full, file = "output/fwc_cuban_bulrush_cv_secchi_binary_model.rda")
save(torp_cv_mod_full, file = "output/fwc_torpedograss_cv_secchi_binary_model.rda")
...
non_foc_mod_full_se <- mod_se_fun(cubu_mean_mod_full, cubu_dat_full, "Cuban bulrush") %>%
  ...
  full_join(mod_se_fun(torp_mean_mod_full, torp_dat_full, "torpedograss", var_type = "HC2") %>%
              mutate(Response = "mean")) %>%
  full_join(mod_se_fun(torp_max_mod_full, torp_dat_full, "torpedograss") %>%
              mutate(Response = "max")) %>%
  full_join(mod_se_fun(torp_min_mod_full, torp_dat_full, "torpedograss", var_type = "HC2") %>%
              mutate(Response = "min")) %>%
...
# save
write_csv(foc_mod_full_se, "output/fwc_focal_secchi_binary_model_summary.csv")
write_csv(non_foc_mod_full_se, "output/fwc_non_focal_secchi_binary_model_summary.csv")
...
write_csv(foc_mod_sum, "output/fwc_focal_secchi_model_summary.csv")
...
write_csv(non_foc_mod_sum, "output/fwc_non_focal_secchi_model_summary.csv")
...
# save
write_csv(foc_mean_summary, "output/fwc_focal_secchi_mean_models.csv")
write_csv(non_foc_mean_summary, "output/fwc_non_focal_secchi_mean_models.csv")
